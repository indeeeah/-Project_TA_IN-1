	...
	<div id="content_con">
		<div id="write_con">
			...
			<div class="upload photo_upload">
				...
				<form class="form_up" action="bbInsert.do" method="post" enctype="multipart/form-data">
						...
						<div id="bbWriteMoreRight" class="bbWriteMoreRight">
							<div id="bbWriteOption" class="bbWriteOption">
								<div class="bbWriteOptionList">
									<input type="text" id="bb_option1" name="bb_option1" onblur="option_onblur(this)" placeholder="옵션1 : option + price">
								</div>
								<div class="bbWriteOptionList">
									<input type="text" id="bb_option2" name="bb_option2" onblur="option_onblur(this)" placeholder="옵션2 : option + price">
								</div>
								<div class="bbWriteOptionList">
									<input type="text" id="bb_option3" name="bb_option3" onblur="option_onblur(this)" placeholder="옵션3 : option + price">
								</div>
								<div class="bbWriteOptionList">
									<input type="text" id="bb_option4" name="bb_option4" onblur="option_onblur(this)" placeholder="옵션4 : option + price">
								</div>
							</div>
						</div>
					</div>

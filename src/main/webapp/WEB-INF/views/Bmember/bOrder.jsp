                ...
                <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                        ...
                        <body>
                            ...
                            <div id="ADaddModal" style="border-radius: 0.5em; border-top-left-radius: 0.5em; border-top-right-radius: 0.5em; border-bottom-left-radius: 0.5em; border-bottom-right-radius: 0.5em;">
                                <form id="updateOrderStatus" action="bOrderStatus.do" method="get">
                                    <span id="imgupload" style="display: inline-block; width: 70%; padding: 18px 0 10px 0; border-style: none; background: white; font-size: 12pt; font-weight: bold;">
										배송상태 수정</span>
                                    ...
                                    <hr style="color: #D5D5D5;">
                                    <input type="submit" id="submit" style="width: 100%; height: 36px; border-style: none; background: white; color: #0095f6; font-size: 12pt; font-weight: bold; cursor: pointer" value="저장">
                                    <hr style="color: #D5D5D5;">
                                    <input type="button" id="clear" style="width: 100%; height: 36px; border-style: none; background: white; color: #FF4848; font-size: 12pt; font-weight: bold; cursor: pointer" value="취소" onclick="location.href='bOrder.do'">
                                </form>
                            </div>
                                            ...
                                            <div style="padding-top: 50px;">
                                                ...
                                                <form action="bOrderDateSearch.do" method="get">
                                                    <div id="JWJsearchassistant">
                                                        <b style="font-size: 7pt">* 조회할 기간 설정&nbsp;&nbsp;</b> <input type="date" id="startdate" name="startdate" value="${startdate }">&nbsp;&nbsp;~&nbsp;&nbsp;
                                                        <input type="date" id="enddate" name="enddate" value="${enddate }">&nbsp;&nbsp;
                                                        <input type="submit" id="setupbtn" name="setupbtn" value="조회하기" class="btn2" style="background: white; border: 1px solid #D5D5D5;">
                                                    </div>
                                                </form>
                                                <br>
                                                    ...
                                                    <c:if test="${bOrderList.size() == 0}">
                                                        <tr>
                                                            <td colspan="13" style="text-align: center; border-style: none;"><br>
                                                                <br> <br> <br> <br> <br> <br><br><br>주문내역이 비어있습니다.<br>
                                                                <br>
                                                                <br> <br> <br> <br> <br>
                                                                <br> <br>
                                                            </td>
                                                    ...
                                                    <c:if test="${bOrderList.size() != 0}">
                                                        <c:forEach var="bol" items="${bOrderList}" varStatus="status">
                                                            <tr class="orderlist">
                                                                ...
                                                                <td>
                                                                    <fmt:formatNumber value="${bol.od_price }" pattern="#,###" />원
                                                                </td>
                                                                <td>${bol.od_name }</td>
                                                                <td>${bol.od_phone }</td>
                                                                <td>${bol.od_addr1 }<br>${bol.od_addr2 }
                                                                    <br>${bol.od_addr3 }</td>
                                                                <td>
                                                                    <c:if test="${bol.od_status eq 'N' }"><span style="padding:4px;background:#CC3D3D; color:white;">배송준비중</span>
                                                                    </c:if>
                                                                    <c:if test="${bol.od_status eq 'Y' }"><span style="padding:4px;background:#F29661; color:white;">&nbsp;&nbsp;&nbsp;배송중&nbsp;&nbsp;&nbsp;</span>
                                                                    </c:if>
                                                                    <c:if test="${bol.od_status eq 'F' }"><span style="padding:4px;background:#6B9900; color:white;">&nbsp;&nbsp;배송완료&nbsp;&nbsp;</span>
                                                                    </c:if>
                                                                </td>
                                                            </tr>
                                                            <tr>

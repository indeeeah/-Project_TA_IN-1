...
<body>
	...
	<div id="ADaddModal"
		...
		<form id="insertbAd" action="insertbAd.do" method="post"
			...
			<label for="upfile" id="imgupload"
				...
				광고컨텐츠 업로드</label> <input id="upfile" type="file"
				accept="image/gif, image/jpeg, image/png" name="upfile"
				style="display: none" required>
			<hr style="color: #D5D5D5;">
			<div id="preview" style="height: 420px;">
				<img id="imgpreview" src="" width="340px" height="auto"
	...
	<div id="mManage">
		...
		<div id="contents" style="padding-top: 30px;">
			...
			<br> <span style="font-size: 8pt; font-weight: bold;">등록된
				광고 컨텐츠는 랜덤으로 다른 사용자들에게 노출됩니다.<br>'추가'버튼을 클릭해 추가, 'x'버튼을 클릭해 삭제할
				수 있습니다.
			</span>
			...
			<div style="padding-top: 40px; padding-left: 50px; text-align: left;">
				<c:if test="${ADList.size() ne 0}">
					<c:forEach var="si" items="${ADList}" varStatus="status">
						<span class="img"> <img class="adimg" style="margin: 10px;"
							src="${pageContext.request.contextPath}/resources/uploadFiles/${si.s_img}"
							width="200px" height="200px" align=top> <input id="s_id"
							type="text" value="${si.s_id }" style="display: none;">
							<button class="deleteAD"
								style=" padding:2px 5px 2px 5px;margin-left: -35px; margin-top: 11px; background: gray; border-style: none; cursor: pointer;">x</button>
						</span>
					</c:forEach>
				</c:if>
				<br> <br>

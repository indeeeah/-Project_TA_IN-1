	    			   ...
	    			   if (dateStr.length <=8) { // 연도의 경우 1900 보다 작거나 yearNow 보다 크다면 false를 반환 
	    				   if (year > yearNow || year < 1900 ){ 
	    					   ...
	    					   $('#birth_check').css('color', 'red'); 
	    						...
	    						$('#birth_check').text('생년월일을 확인해주세요 '); 
	    						$('#birth_check').css('color', 'red'); 
	    					}else if (day < 1 || day > 31) { $('#birth_check').text('생년월일을 확인해주세요 '); 
	    					$('#birth_check').css('color', 'red'); 
...
<body>
	<article class="container">
		...
		<div class="col_sm col_md_3">
			<form action="${pageContext.request.contextPath}/member/join.do" method="post" role="form" id="usercheck"
				name="member">

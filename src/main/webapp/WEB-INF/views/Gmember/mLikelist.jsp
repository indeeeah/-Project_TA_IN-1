                            ...
                            <div id="sc_con">
                                <div id="menu">
                                    <ul id="menulist">
                                        ...
                                        <li style="border-left: 2px solid black;"><a href="mLikelist.do"><span style="font-weight: bold;">내가
							누른 좋아요 조회</span></a></li>
                                ...
                                <div id="contents" style="padding-top: 30px;">
                                    <div id="submenu" style="padding-top: 30px;">
                                        <input type="button" id="all" class="submenu" value="전체" style="background: white; text-align: center; width: 120px; border: 2px solid black;" onclick="location.href='mLikelist.do'"> <input type="button" id="board"
                                            class="submenu" value="일반 게시글" style="background: white; text-align: center; width: 120px;" onclick="location.href='mLikelistboard.do'"> <input type="button" id="bboard" class="submenu" value="비즈니스 게시글" style="background: white; text-align: center; width: 120px;"

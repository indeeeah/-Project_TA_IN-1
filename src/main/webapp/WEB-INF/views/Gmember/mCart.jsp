                                    ...
                                    <div id="contents" style="padding-top: 30px;">
                                        <table id="cartlist" style="font-size: 10pt; margin: 40px 0 60px 0;">
                                            ...
                                            <c:if test="${cartlist.size() != 0}">
                                                <c:forEach var="cl" items="${cartlist}" varStatus="status">
                                                    ...
                                                    <tr>
                                                        <td align="center"><input type="checkbox" checked name="chk"><input type="text" id="bb_id" style="display: none;" value="${cl.bb_id}"></td>
                                                        <td style="vertical-align:bottom;border-style: none; border-bottom: 1px solid #D5D5D5;">
                                                            <a href=""><img src="${cl.bb_img1 }" style="width: 110px; height: 110px; padding: 0 0 0 0;"></a>
                                                        </td>
                                                        <td style="border-style: none; border-bottom: 1px solid #D5D5D5;">
                                                            ${cl.bb_name}</td>
                                                        <td><input type="text" id="price" style="display: none;" value="${cl.bb_price}"><span id="result">
																<fmt:formatNumber value="${price}" pattern="#,###" />
															</span></td>
                                                        <td>
                                                            <input type="button" class="p" value="+" style="background:white; border:1px solid #D5D5D5;">
                                                            <br> <input type="text" name="pop_out" value="1" id="amount" class="amount" style="text-align: center; width: 50px; border:1px solid #D5D5D5;" /><br>
                                                            <input type="button" class="p" value="-" style="background:white; border:1px solid #D5D5D5;">
                                                        </td>
                                                        <td><input type="text" id="sum" style="text-align: center; width: 60px; border-style: none;" value="<fmt:formatNumber
										value=" ${price} " pattern="#,### " />원"></td>
                                                        <td><input type="button" id="order" value="주문하기" style="background: white; border: 1px solid #D5D5D5; margin:0px;" class="btn2" onclick="location.href='mBuy.do?bb_id=${cl.bb_id}'">
                                                            <br><br><input type="button" id="delete" value="삭제" style="background: white; border: 1px solid #D5D5D5; margin:0px;" class="btn2" onclick="location.href='mDeleteCart.do?bb_id=${cl.bb_id}'">
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        ...
                                        <table style="width:100%; font-size:10pt; border-top: 2px solid gray; border-bottom: 2px solid gray;">
                                            <tr>
                                                <td>총 상품금액</td>
                                                <td>총 배송비</td>
                                                <td>결제예정 금액<span style="font-size:7pt;"><br>(*옵션 선택에 따라 변동될 수
														있습니다.)</span></td>
                                            </tr>
                                            <tr height="60px">
                                                <td><span id="presult" style="font-size:14pt; font-weight:bold;">
														<fmt:formatNumber value="${productprice}" pattern="#,###" />원
													</span></td>
                                                <td><span style="font-size:14pt; font-weight:bold;">+ 3,000원</span></td>
                                                <td><span id="finalresult" style="font-size:14pt; font-weight:bold;">
														<fmt:formatNumber value="${allprice}" pattern="#,###" />원
													</span></td>
                                            </tr>
                                        </table>
                                        <div style="padding:40px 0 30px 0;">
                                            <input type="button" id="orderlist" class="btn2" style="background: #6782B4; padding: 5px 20px 5px 20px; color: white;" " value=" 주문하기 " style="background: white; border: 1px solid #D5D5D5; ">
											<input type="button " id="deletelist " class="btn2 "
												style="background: #6782B4; padding: 5px 20px 5px 20px; color: white; "" value="
												삭제하기" style="background: white; border: 1px solid #D5D5D5;">
                                        </div>
                                    </div>
                                </div>
                            </div>

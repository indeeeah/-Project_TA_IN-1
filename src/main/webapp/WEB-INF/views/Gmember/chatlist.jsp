					...
					function() {
						...
						function connect() {
							...
							ws.onmessage = function(event) {
								...
								$("input[value=" + id + "]").parent().css(
										"display", "block");
								$(".msg_history")
										.html(
												msghistory
														+ "<div class='received_msg'><div class='received_withd_msg'><div class='incoming_msg_img'><img width='44px' src='${pageContext.request.contextPath}/resources/uploadFiles/${chatImg}'><b style='font-size: 9pt;'>"
														+ id
														+ "</b></div><p>"
														+ msg
														...
														+ "</span></div></div><br>");
								setTimeout(function() {
									var scrollTop = $(".msg_history")
											.scrollTop();
									$(".msg_history").scrollTop(
											$(document).height() + 100000);
								}, 10);
							};
															...
															if ($("#searchf")
																...
																for (var i = 0; i < result.userId.length; i++) {
																	...
																	$(
																			"#resultdiv")
																			.append(
																					"<button style='width:100%; text-align:left; font-size:10pt; background:none; border-style:none; cursor:pointer; padding:5px 0 5px 0;' onclick=\"location.href='showchat.do?m_id2="
																							+ rs
																							+ "'\">"
																							+ rs
																							+ "</button><br>");
					...
					<div class="headind_srch">
						...
						<div class="srch_bar">
							<div class="stylish-input-group">
								<input type="text" id="searchf" class="search-bar"
							...
							<div class="chat_list active_chat">
								<div class="chat_people">
									<div class="chat_img"
										...
										<img
											src="${pageContext.request.contextPath}/resources/uploadFiles/${userImg[status.index] }"
								...
								<c:if test="${readcheck[status.index].m_check ne 'N'}">display:none;</c:if>">
										<input type="text" value="${ml.chat}" style="display: none;">
									</div>
									<div class="chat_ib" style="">
										<h5>
											${ml.chat}<input type="text" value="${ml.chat}"
												style="display: none;"> <span class="chat_date">${ml.lastdate }</span>
										</h5>
										<p></p>
									</div>
								</div>

					...
					<div id="tb_box">
						<table id="mM_table">
							<tr id="table_top">
								<td colspan="4" style="border: none;" align="left">
									<form method="post" name="listForm"
										action="bsboardManagelist.do">
										<input type="hidden" name="page" value="${currentPage}">
										<input type="text" name="keyword"> <input
											class="btn-action" type="submit" value="검색">
									</form>
								</td>
								<td align="right" colspan="7" cellspacing="0"
							...
							<c:if test="${listCount eq 0}">
								<tr class="table_body">
									<td colspan="7" align="center"><br> <br> 등록된
										게시물이 없습니다.<br> <br></td>
								</tr>
							</c:if>
								...
								<c:forEach var="vo" items="${list}" varStatus="status">
									<tr class="table_body">
										...
										<td align="center"><a class="btn-delete"
											onclick="if(confirm('정말 삭제 처리 하시겠습니까?')){href='bsbManageDelete.do?bb_id=${vo.bb_id}'}">삭제</a></td>
									</tr>
								</c:forEach>
							</c:if>

...
public class BusinessMemberVO {
	...
	public String toString() {
		return "BeusinessMemberVO [m_id=" + m_id + ", bm_cate=" + bm_cate + ", bm_name=" + bm_name + ", bm_addr="
				+ bm_addr + ", bm_url=" + bm_url + ", bm_qr=" + bm_account + ", bm_intro=" + bm_intro + ", bm_phone="
				+ bm_phone + ", bm_approvl=" + bm_approval + "]";
	}
	...
	public void setBm_account(String bm_qr) {
		this.bm_account = bm_qr;
	}

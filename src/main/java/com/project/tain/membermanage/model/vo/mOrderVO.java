...
public class mOrderVO {
	...
	public mOrderVO(String bb_id, String m_id, Date od_date, String od_size, int od_amount, String od_options,
			int od_price, String od_name, String od_phone, int od_addr1, String od_addr2, String od_addr3,
			String od_status) {
		super();
		this.bb_id = bb_id;
		this.m_id = m_id;
	...
	public String toString() {
		return "mOrderVO [bb_id=" + bb_id + ", m_id=" + m_id + ", od_date=" + od_date + ", od_size=" + od_size
				+ ", od_amount=" + od_amount + ", od_options=" + od_options + ", od_price=" + od_price + ", od_name="
				+ od_name + ", od_phone=" + od_phone + ", od_addr1=" + od_addr1 + ", od_addr2=" + od_addr2
				+ ", od_addr3=" + od_addr3 + ", od_status=" + od_status + "]";
	}

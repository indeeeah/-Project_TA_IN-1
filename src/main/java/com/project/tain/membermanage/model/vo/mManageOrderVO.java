...
public class mManageOrderVO {
	...
	public mManageOrderVO(String seller, String bb_id, String m_id, Date od_date, String od_size, int od_amount,
	...
	public String toString() {
		return "mManageOrderVO [seller=" + seller + ", bb_id=" + bb_id + ", m_id=" + m_id + ", od_date=" + od_date
